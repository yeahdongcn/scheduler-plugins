...
import (
	...
	"sigs.k8s.io/scheduler-plugins/pkg/coscheduling/core/slurm"
)

func Benchmark_eval_nodes_tree_topo3(b *testing.B) {
	err := switch_record_validate("../../../../../../testdata/slurm/topology3.conf")
...
func Test_eval_nodes_tree_topo2(t *testing.T) {
	err := switch_record_validate("../../../../../../testdata/slurm/topology2.conf")
	require.NoError(t, err)
...
func Test_eval_nodes_tree_topo1(t *testing.T) {
	err := switch_record_validate("../../../../../../testdata/slurm/topology1.conf")
	require.NoError(t, err)
